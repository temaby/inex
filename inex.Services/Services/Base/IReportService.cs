...
{
    Task<PagedResponse<CategoryListDetailsDTO, ReportMetadata>> GetCategoriesReportData(int userId, string currency, IDictionary<string, string> filters, CancellationToken ct = default);
