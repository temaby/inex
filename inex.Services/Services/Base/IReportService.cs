...
public interface IReportService : IDisposable
{
    ...
    Task<MonthlyFinancialReport> GetMonthlyFinancialReport(int userId, int? year = null, int? month = null, CancellationToken ct = default, IReadOnlyCollection<int>? accountIds = null, IReadOnlyCollection<int>? linkedUserIds = null);
    Task<byte[]> GetMonthlyFinancialReportPdf(int userId, int? year = null, int? month = null, CancellationToken ct = default, IReadOnlyCollection<int>? accountIds = null, IReadOnlyCollection<int>? linkedUserIds = null);
}
