...
public class ReportsController : ApiControllerBase
{
    ...
    public async Task<IActionResult> GetMonthlyFinancialPdf([Range(2, 9998)] int? year = null, [Range(1, 12)] int? month = null, [FromQuery] int[]? accountIds = null, [FromQuery] int[]? linkedUserIds = null, CancellationToken ct = default)
    {
        byte[] pdf = await _reportService.GetMonthlyFinancialReportPdf(CurrentUserId, year, month, ct, accountIds, linkedUserIds);
